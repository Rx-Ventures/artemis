 ...
 * dialog result and deciding whether it is something Artemis is willing to hand
 ...
 * cancelling, leaving Artemis, creating the folder, and coming back. That detour
 ...
 * `checkWorkingDirectory`'s job in `@rx-artemis/core`, and the caller runs it so
