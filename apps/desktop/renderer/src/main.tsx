 ...
 * the UI can do goes through `window.artemis`, the contextBridge surface
 * described by `ArtemisBridge` in `@rx-artemis/protocol`.
 */
...
if (!container) throw new Error('Artemis: #root is missing from index.html');
