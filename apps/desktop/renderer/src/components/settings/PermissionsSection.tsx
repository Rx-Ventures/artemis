 ...
 * Libra cannot yet decide — an honest account of who does decide.
 *
 * ---------------------------------------------------------------------------
 ...
 * control in this app follows, applied to a gap in Libra rather than a gap in
 * the provider.
 */

import type { ReactElement } from 'react';
import { ShieldIcon } from 'lucide-react';
import type { PermissionMode } from '@libra/protocol';
...
const NO_TOOL_POLICY =
  'Libra has nowhere to keep this yet. The protocol carries it per run, but no setting writes it, so anything typed here would be lost when this dialog closes.';
    ...
    >
          ...
          <Empty className="border border-dashed border-line py-10">
            <EmptyHeader>
              ...
              <EmptyDescription className="text-2xs">
                ...
                prompt, and Libra has no way to ask it for something different.
              </EmptyDescription>
            </EmptyHeader>
          </Empty>
        ) : (
      ...
      <SettingsGroup label="Tool policy">
        ...
        <p className="text-2xs leading-relaxed text-ink-faint">
          ...
          reads it — its config file for this project. Libra sends no allow list, no deny list and no
