...
export function ProfilesSection(): ReactElement {
  ...
  return (
    <SettingsPane
      title="Profiles"
      description="Each profile is a Claude account and its own history, kept in its own config directory. Switching is manual — Artemis never pools accounts or rotates them for you."
      actions={
        creating ? null : (
    ...
    >
      <div className="flex flex-col gap-3">
        ...
        <p className="mt-1 text-2xs leading-relaxed text-ink-faint">
          Artemis stores no credential of any kind. Signing in runs Claude’s own CLI against the
          profile’s config directory, and the credential it writes stays there — Artemis sets one
        ...
        <form onSubmit={(event) => void submit(event)}>
          <FieldGroup className="gap-4">
            ...
            <Field>
              ...
              <FieldDescription className="text-2xs">
                Claude keeps this profile’s login and its session history here. Artemis suggests a
