...
.diff pre { font: 10.5px/1.55 var(--mono); background: var(--well); overflow: hidden; white-space: normal; }
...
.dock pre { flex: 1; font: 10.5px/1.6 var(--mono); padding: 6px 0; overflow: hidden; background: var(--well); white-space: normal; }
