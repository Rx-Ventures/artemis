/**
 * `@libra/protocol` — the shared contract.
 *
 ...
 * | `ipc`           | channel constants, request/response maps, `LibraBridge`    |
 *
 * What does *not* live here: the `ProviderAdapter` / `Run` interfaces. Those
 * are the engine's seam and live in `@libra/core/adapters`, because they
