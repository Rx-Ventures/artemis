 ...
 *
 * **Problem 2 — you cannot just inherit everything either.** Artemis's whole
 ...
 * shell that launched Artemis, a Bedrock profile would silently authenticate
 ...
 * the one the profile happens to use. Both of Artemis's auth modes are in it —
