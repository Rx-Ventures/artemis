...
import type { ProviderDescriptor, ProviderId } from '@libra/protocol';
import { NO_CAPABILITIES, PROVIDER_IDS } from '@libra/protocol';
...
const NOT_IMPLEMENTED_REASON = 'Not supported in this version of Libra yet.';
